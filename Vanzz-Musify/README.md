...
![VANZZ MUSIFY](docs/branding/lyreon-banner.png)

### *Hear What Words Can't Say*

**VANZZ MUSIFY** adalah aplikasi musik Android *audio-only* untuk YouTube Music — pencarian penuh, playlist, unduhan offline, pemutaran latar (background), dan rekomendasi radio otomatis, dibalut tema gelap‑crimson.

`Kotlin` · `Jetpack Compose` · `Media3 ExoPlayer` · `MetrolistExtractor` · `Room`

[Channel WhatsApp Vanzz](https://whatsapp.com/channel/0029Vb92Ukw3AzNQEwPAKN0m)
